...
def ethos_training(args):
    ...
    source_file1 = './method/ethos_train/training_loop.py'
    source_file2 = './method/ethos_train/model.py'
    ...
    while True:
        ...
        if iter_num % args.eval_interval == 0 and master_process:
            ...
            print(
                "step {}: train loss {:.4f}, val loss {:.4f}, train uncertainty {:.4f}, val uncertainty {:.4f}".format(
                    iter_num,
                    losses["loss/train"],
                    losses["loss/val"],
                    losses["uncertainty/train"],
                    losses["uncertainty/val"],
                )
            )
            checkpoint = {
