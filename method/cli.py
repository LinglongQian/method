...
class ProjectCLI(click.MultiCommand):
    ...
    method.commands package. Each module in that
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        for mod_info in pkgutil.iter_modules(commands.__path__):
            name = mod_info.name
            full_name = f"method.commands.{name}"
...
def run_cli() -> None:
    ...
    cli = ProjectCLI(help="Main entrypoint for the method project.")
    cli()
