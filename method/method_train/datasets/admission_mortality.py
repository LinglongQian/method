...
class _AdmissionMortalityBase(InferenceDataset, abc.ABC):
    ...
    def __init__(
        self, data, encode, sequence_length: int, admission_stoken: str, toi_stokens: Iterable[str]
    ):
...
class AdmissionMortalityDataset(_AdmissionMortalityBase):
    ...
    def __init__(self, data, encode, sequence_length: int):
        ...
        super().__init__(data, encode, sequence_length, ADMISSION_STOKEN, stokens_of_interest)
